...
function main() {
  ...
  if (!mode || !['local', 'remote'].includes(mode)) {
    ...
    console.log('==================================')
    console.log()
    console.log('Usage: node switch-supabase-config.js [local|remote]')
    console.log()
    console.log('Examples:')
    console.log('  node switch-supabase-config.js local   # Switch to local development')
    console.log('  node switch-supabase-config.js remote  # Switch to production')
    console.log()
    return
  }
